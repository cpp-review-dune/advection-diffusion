...
template <> const Point<1> RightHandSide<1>::center_point = Point<1>(-0.75);
...
private:
  template <int dim> struct EstimateScratchData {
...
GradientEstimation::EstimateScratchData<dim>::EstimateScratchData(
    ...
    : fe_midpoint_value(fe, QMidpoint<dim>(),
                        update_values | update_quadrature_points),
      solution(solution), error_per_cell(error_per_cell),
...
GradientEstimation::EstimateScratchData<dim>::EstimateScratchData(
    ...
    : fe_midpoint_value(scratch_data.fe_midpoint_value.get_fe(),
      ...
      error_per_cell(scratch_data.error_per_cell), cell_midpoint_value(1),
